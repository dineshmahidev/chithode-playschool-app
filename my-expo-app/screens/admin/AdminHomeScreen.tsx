        ...
        {list.length > 0 ? (
          ...
          >
            {list.map((item) => (
              <TouchableOpacity 
                ...
                className="mr-3 bg-brand-pink relative overflow-hidden rounded-2xl border-2 border-white shadow-2xl"
          ...
          <View className="px-6">
            <LinearGradient
              ...
              className="items-center justify-center rounded-2xl border-2 border-brand-pink/10 border-dashed"
            >
          ...
          >
              ...
              >
                  <View className="flex-row items-center justify-between mb-8">
                      ...
                      <View className={`${theme === 'dark' ? 'bg-white/10 border-white/10' : 'bg-brand-pink/10 border-brand-pink/20'} px-3 py-1.5 rounded-full border`}>
                          <Text className={`${theme === 'dark' ? 'text-white' : 'text-brand-pink'} text-[10px] font-black uppercase`}>Live Updates</Text>
                      </View>
                  </View>
                  ...
                  <View className="flex-row justify-between items-center">
                      ...
                      <TouchableOpacity 
                         onPress={() => handleQuickAction('userManagement')}
                         className={`${theme === 'dark' ? 'bg-white/5 border-white/5' : 'bg-brand-pink/10 border-brand-pink/20'} rounded-[20px] p-4 w-[46%] border`}
                      >
                          <View className="flex-row items-center mb-4">
                              <View className="bg-brand-pink w-10 h-10 rounded-2xl items-center justify-center mr-3 shadow-lg">
                          ...
                          <View className={`${theme === 'dark' ? 'bg-white/5 border-white/5' : 'bg-brand-pink/20 border-brand-pink/30'} px-2 py-1.5 rounded-xl border`}>
                            <Text className={`${theme === 'dark' ? 'text-white' : 'text-brand-pink'} text-[9px] font-black uppercase text-center`}>Active Faculty</Text>
                          </View>
                      </TouchableOpacity>
                  </View>

                  {/* Decorative Background Patterns */}
                  <View className="absolute -top-10 -right-10 w-32 h-32 bg-brand-pink/5 rounded-full blur-3xl" />
                  ...
                  <View className="absolute -bottom-6 -right-6 opacity-10">
                      <MaterialCommunityIcons name="shield-check-outline" size={100} color={theme === 'dark' ? 'white' : '#F472B6'} />
                  </View>
              </LinearGradient>
          </TouchableOpacity>
        </View>
                ...
                >
                    ...
                    >
                        <View className="flex-row items-center justify-between mb-6">
                            ...
                            <Text className="text-white/80 font-black text-[8px] uppercase tracking-widest">Fees</Text>
                        </View>
                        <View className="flex-row items-center">
                            <Text className="text-3xl font-black text-white">{paidFeeCount}</Text>
                            <Text className="text-white/40 text-[12px] font-bold mx-1">/</Text>
                            <Text className="text-[10px] font-black uppercase tracking-widest text-white/60">{totalFeeCount}</Text>
                        </View>
                        <Text className="text-white/60 text-[9px] font-bold uppercase tracking-tighter">Collected</Text>
                        ...
                        <Text className="text-white font-black text-[10px] mt-3 uppercase tracking-tighter self-end">{Math.round(totalFeeCount > 0 ? (paidFeeCount / totalFeeCount) * 100 : 0)}% Clear</Text>
                    </LinearGradient>
                </TouchableOpacity>
                ...
                >
                    ...
                    >
                        <View className="flex-row items-center justify-between mb-6">
                            ...
                            <Text className="text-white/80 font-black text-[8px] uppercase tracking-widest">Presence</Text>
                        </View>
                        <View className="flex-row items-center">
                             <Text className="text-3xl font-black text-white">{presentToday}</Text>
                             <Text className="text-white/40 text-[12px] font-bold mx-1">/</Text>
                             <Text className="text-[10px] font-black uppercase tracking-widest text-white/60">{studentCount}</Text>
                        </View>
                        <Text className="text-white/60 text-[9px] font-bold uppercase tracking-tighter">Attending Today</Text>
                        ...
                        <Text className="text-white font-black text-[10px] mt-3 uppercase tracking-tighter self-end">{Math.round(studentCount > 0 ? (presentToday / studentCount) * 100 : 100)}% Present</Text>
                    </LinearGradient>
                </TouchableOpacity>
            </View>
        </View>
