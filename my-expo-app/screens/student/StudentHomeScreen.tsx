        ...
        {list.length > 0 ? (
          ...
          >
            {list.map((item, index) => (
              <TouchableOpacity 
                ...
                className={`${index === list.length - 1 ? '' : 'mr-4'} bg-brand-pink relative overflow-hidden rounded-[20px] border-2 border-white shadow-xl`}
          ...
          <View className="items-center px-6">
            <LinearGradient
              ...
              style={{ width: cardWidth, aspectRatio: 16 / 9 }}
              className="items-center justify-center rounded-[20px] border-2 border-brand-pink/10 border-dashed"
            >
    ...
    <View className={`flex-1 ${colors.background}`}>
      ...
      >
        ...
        <View className="px-6 py-6">
          ...
          {/* Secondary Duo Row: Activity Feed & Live Feed */}
          <View className="flex-row justify-between">
            <TouchableOpacity
              activeOpacity={0.9}
              onPress={() => navigation.navigate('activityFeed')}
              className="w-[48%] rounded-[20px] overflow-hidden shadow-lg"
              style={{ elevation: 12 }}
            >
              <LinearGradient
              ...
              >
                ...
                <View>
                  <Text className="text-white text-xl font-black tracking-tighter">Activity Feed</Text>
                  <Text className="text-white/80 text-[10px] font-bold mt-1 uppercase tracking-wider">Class Highlights</Text>
                </View>
            ...
            >
              ...
              >
                ...
                <View>
                  ...
                  <Text className="text-white/80 text-[10px] font-bold mt-1 uppercase tracking-wider">Secure Stream</Text>
                </View>
                <View className="absolute -bottom-4 -right-4 opacity-10">
